...
VL_ATTR_COLD void Vsim___024root___ctor_var_reset(Vsim___024root* vlSelf) {
    ...
    vlSelf->sim__DOT__u_single_cycle_cpu__DOT__mem_data_out = VL_RAND_RESET_I(32);
    ...
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->sim__DOT__u_single_cycle_cpu__DOT__u_mem_ddr__DOT__mem[__Vi0] = VL_RAND_RESET_I(32);
    }
    ...
    for (int __Vi0 = 0; __Vi0 < 64; ++__Vi0) {
        vlSelf->sim__DOT__u_single_cycle_cpu__DOT__u_dpi_verilator__DOT__inst_str[__Vi0] = VL_RAND_RESET_Q(64);
    }
    for (int __Vi0 = 0; __Vi0 < 32; ++__Vi0) {
        vlSelf->sim__DOT__u_single_cycle_cpu__DOT__u_dpi_verilator__DOT__reg_name[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->sim__DOT__u_single_cycle_cpu__DOT__u_dpi_verilator__DOT__counter = VL_RAND_RESET_Q(64);
